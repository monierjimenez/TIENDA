...
@section('content')
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-items set-bg" data-setbg="images/hero-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
            ...
            <div class="single-hero-items set-bg" data-setbg="images/hero-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
    ...
    <section class="women-banner spad">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    <div class="product-large set-bg" data-setbg="images/products/women-large.jpg">
                        <h2>Women’s</h2>
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                ...
                                <ul>
                                    <li class="w-icon active"><a href="#"><i class="fa fa-opencart"></i></a></li>
    ...
    <section class="deal-of-week set-bg spad" data-setbg="images/time-bg.jpg">
        <div class="container">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="product-large set-bg m-large" data-setbg="images/products/man-large.jpg">
                        <h2>Men’s</h2>
                        <a href="#">Discover More</a>
                    </div>
                </div>
    ...
    <div class="instagram-photo">
        ...
        <div class="insta-item set-bg" data-setbg="images/insta-2.jpg">
            <div class="inside-text">
                <i class="fa fa-instagram"></i>
                <h5><a href="#">colorlib_Collection</a></h5>
            </div>
        </div>
        <div class="insta-item set-bg" data-setbg="images/insta-3.jpg">
            <div class="inside-text">
                <i class="fa fa-instagram"></i>
                <h5><a href="#">colorlib_Collection</a></h5>
            </div>
        </div>
        <div class="insta-item set-bg" data-setbg="images/insta-4.jpg">
            <div class="inside-text">
                <i class="fa fa-instagram"></i>
                <h5><a href="#">colorlib_Collection</a></h5>
            </div>
        </div>
        <div class="insta-item set-bg" data-setbg="images/insta-5.jpg">
            <div class="inside-text">
                <i class="fa fa-instagram"></i>
                <h5><a href="#">colorlib_Collection</a></h5>
            </div>
